...
public class WaypointTraversal {
	...
	public static void main(String args[]) {
		...
		if (args[0].equalsIgnoreCase("PointSetList")) {
			...
			points = new PointSetSortedList<Waypoint>(PointSetSortedList.ORDER_BY_X);
		} else if (args[0].equalsIgnoreCase("ByY")) {
			points = new PointSetSortedList<Waypoint>(PointSetSortedList.ORDER_BY_Y);
		} else {
			System.err.println("Usage: java WaypointTraversal [PointSetList|Quadtree|ByX|ByY] outfile infiles");
			System.exit(1);
		}
