...
public class SmallTest {
	...
	public static void main(String args[]) {
		...
		// PointSet2D<Point2D.Double> points = new PointSetList<Point2D.Double>();
		// PointSet2D<Point2D.Double> points = new Quadtree<Point2D.Double>(-100,
		// 100, -100, 100, 4);
		PointSet2D<Point2D.Double> points = new PointSetListSorted<Point2D.Double>(PointSetListSorted.ORDER_BY_Y);
